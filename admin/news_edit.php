...
\*******************************************************************/
	...
	if (isset($_POST['action']) && $_POST['action'] == "edit_news")
	{
		...
		if (count($errs) == 0)
		{
			$sql = "UPDATE abbijan_news SET news_title='$news_title', news_description='$news_description', status='$status' WHERE news_id='$news_id' LIMIT 1";
	...
	if (isset($_GET['id']) && is_numeric($_GET['id']))
	{
		...
		$query = "SELECT * FROM abbijan_news WHERE news_id='$news_id' LIMIT 1";
