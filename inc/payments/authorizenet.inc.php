...
class authorizenet_class {
   ...
   var $gateway_url = "https://secure.authorize.net/gateway/transact.dll"; // https://test.authorize.net/gateway/transact.dll
   ...
   function process() {
	  ...
	  curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, FALSE); // turn off certificate verification
